...
ggsave(filename = "./plots/model10.0_brain_biomarker2.jpeg", 
       plot = brain_plot, 
       device = "jpeg", 
       height = 100, 
       width = 200, 
...
ggsave(filename = "./plots/model10.0_heart_biomarker2.jpeg", 
       plot = heart_plot, 
       device = "jpeg", 
       height = 100, 
       width = 200, 
...
ggsave(filename = "./plots/model10.3_kidney_biomarker2.jpeg", 
       plot = kidney_plot, 
       device = "jpeg", 
       height = 100, 
       width = 200, 
...
ggsave(filename = "./plots/model10.3_liver_biomarker2.jpeg", 
       plot = liver_plot, 
       device = "jpeg", 
       height = 100, 
       width = 200, 
...
ggsave(filename = "./plots/model10.3_muscle_biomarker2.jpeg", 
       plot = muscle_plot, 
       device = "jpeg", 
       height = 100, 
       width = 200, 
...
ggsave(filename = "./plots/model10.3_whole_biomarker2.jpeg", 
       plot = whole_plot, 
       device = "jpeg", 
       height = 100, 
       width = 200, 
