...
#model41_marker_herbicide <- readRDS(file = "./results/models/model41_marker_embryo.RDS")
...
#saveRDS(object = model45_marker_pesticide, file = "./results/models/model45_marker_pesticide_biomarker2.RDS")
...
# plot
marker_pesticide_plot <- orchard_plot_PCL(object = model45_marker_pesticide, 
                                          mod = "Biomarker.Category_2", 
                                          est_point_size = 5,
                                          alpha = 0.5,
                                          cb = FALSE,
