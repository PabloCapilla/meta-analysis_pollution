...
##
##
table(df00$Developmental.Stage, df00$Biomarker.Category)
...
#saveRDS(object = model32_marker_Tadpole, file = "./results/models/model32_marker_tadpole_trimmed.RDS")
...
ggsave(filename = "./plots/model32_biomarker_tadpole.pdf", 
...
ggsave(filename = "./plots/model33_biomarker_adult.pdf", 
